 ...
 * based on the current activity lifecycle state and the user's preference for launching
 * the background isolate even if the app is open.
 *
...
class DefaultIsolateLaunchPolicy(
    ...
    override fun shouldLaunch(): Boolean {
        ...
        return launchEvenIfAppIsOpen || isolate == IsolateType.BACKGROUND
    }
}
