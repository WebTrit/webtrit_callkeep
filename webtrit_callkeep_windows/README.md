...
Windows stub implementation of [`webtrit_callkeep`](../webtrit_callkeep/README.md).

This package is a no-op placeholder that satisfies the federated plugin requirement for Windows.
